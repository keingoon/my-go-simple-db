...
// Compensation SetStr log cannot be undone
func (r *CompensationSetStrRecord) Undo(ctx context.Context, txAccess *access.Transaction) {}

func (r *CompensationSetStrRecord) Redo(ctx context.Context, txAccess *access.Transaction) {
