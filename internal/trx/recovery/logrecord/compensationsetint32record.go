...
func WriteCompensationSetInt32ToLog(lm *log.LogMgr, prevLSN int32, txnum int32, blk *file.BlockId, offset int32, oldVal int32, newVal int32, undoNextLSN int32) (int32, error) {
	recLen := int32Size + int32Size + int32Size + int32(file.VarBytesLen(len(blk.FileName()))) + int32Size + int32Size + int32Size + int32Size + int32Size
	enc := newRecordEncoder(recLen)
	if err := enc.PutInt32(compensationSetInt32); err != nil {
